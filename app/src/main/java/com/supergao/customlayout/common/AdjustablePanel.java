package com.supergao.customlayout.common;
...
import com.supergao.customlayout.R;
import com.supergao.customlayout.Utils;

import androidx.appcompat.widget.AppCompatSeekBar;

/**
 * 这个类是用来做 ImageView 外部的可调整框架
 */
    ...
    protected void onAttachedToWindow() {
        ...
        SeekBar.OnSeekBarChangeListener listener = new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int percent, boolean b) {
                ...
                layoutParams.width = (int) (minWidth + (AdjustablePanel.this.getWidth()
                        - minWidth) * widthBar.getProgress() / 100);
                layoutParams.height = (int) (minHeight + (AdjustablePanel.this.getHeight()
